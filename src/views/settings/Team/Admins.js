...
import { notification, List, Avatar, Spin, Space, Button, Popover, Modal } from 'antd';

// import InviteAdminStaffModal from './InviteAdminStaffModal';
// import AdminStaffActionButton from './AdminStaffActionButton';
...
const Admins = ({ navigation }) => {
  ...
  function confirmRevokeInvite(adminId) {
    Modal.confirm({
      title: 'Revoke invite',
      icon: <ExclamationCircleOutlined />,
      content: `Revoking the invite will mean the invited admin won't be able to join your team again`,
  ...
  function renderPopoverContent(adminId) {
    return (
      <div>
        <Buttons
          btnText="Revoke invite"
          textColor={colors.pinkDark}
          btnAction={() => confirmRevokeInvite(adminId)}
          style={{
            padding: '0 0 10px 0',
            marginTop: 0,
            marginBottom: 20,
  ...
  return (
    <div style={{ zIndex: 1 }}>
      {businessStaffs.size > 0 && (
        <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
          <Buttons
            btnText="Add admin"
            textColor={colors.pinkDark}
            btnAction={() => setAddAdminModalVisible(true)}
            style={{
      ...
      <div>
        <p style={{ ...fontsize.h4, color: colors.black2, fontWeight: 600 }}>ACTIVE ADMINS</p>
        ...
        {businessStaffs.size > 0 && pendingAdmin.length > 0 && (
          <>
            <p style={{ ...fontsize.h4, color: colors.black2, fontWeight: 600 }}>PENDING ADMINS</p>
            <List
